...
function animateCurrentPositon(deltaLat, deltaLng) {
    ...
    let bearing = getBearing(lat, lng, userLocation.lat(), userLocation.lng()); //get bearing through calculations before userMarker is updated
...
function rotateIcon(bearing){
    ...
    userMarker.icon.rotation = bearing;
}
    ...
    jQuery.ajax({
        ...
        /*
                if (distanceCheck < maxDistPOI && distanceCheck != false) {
                    ...
                    jQuery('#pButton').attr('href', '#');
                    jQuery('#pButton').html('JE KUNT DIT ZIEN OVER: ' + Math.round(distanceCheck-maxDistPOI) + ' KM');
                    jQuery('#pButton').addClass('not-active');
                    jQuery('#pButton').css("color", "#ddd");
                    jQuery('#pReload').attr('href', '#');
                    ...
                    jQuery('#pButton').attr('href', '#');
                    jQuery('#pButton').html('JE SPEELT DIT VRIJ OVER: ' + Math.round(distanceCheck-maxDistPOI) + ' KM');
                    jQuery('#pButton').addClass('not-active');
                    jQuery('#pButton').css("color", "#ddd");
                    jQuery('#pReload').attr('href', '#');
                    jQuery('#pReload').html('<a href="javascript:void(0)" onclick="loadLocation()">HERLAAD AFSTAND &#8635;</a>');
...
//Steven try to combine all jQuery duplicates
